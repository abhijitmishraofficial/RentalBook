		...
		<table class="table" border="4px"
			...
			<tr>
				<th colspan="8" class="text-center"><b
					class="btn btn-secondary" class="text-white">Your Cart Status</b></th>
			</tr>
			...
			<tr>
				<td colspan="4"><b class="text-danger">Total price</b><b
					style="margin-left: 500px;"> <%=totalprice%></b> <a
					href="order.jsp?id=${userobj.id }" class="btn btn-primary"
					style="float: right; mrgin-right: 10px">ORDER NOW</a></td>
			</tr>
